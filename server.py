...
# every hang capture showing an ESTABLISHED TCP to  with MCP client
...
Profile model:
  Each registrable domain (eTLD+1) — e.g. "example.com", "news.ycombinator.com" —
...
async def navigate(url: str, profile: str = "") -> str:
    ...
    The profile is derived from the URL's eTLD+1 (e.g. "example.com") unless
...
async def save_playbook(
    ...
    Args:
        name: Unique playbook name (e.g., 'acme_account_summary').
