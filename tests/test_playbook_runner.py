...
VARIANT_FRESH_SEL = "#dom-username-input"
VARIANT_REMEMBERED_SEL = (
    ...
    return [
        {
            ...
            "variants": [
                {"name": "fresh", "selector": VARIANT_FRESH_SEL},
                {"name": "remembered", "selector": VARIANT_REMEMBERED_SEL},
            ],
...
def _install_fake_fill_login(
    ...
    async def fake_fill_login(_client, _page, url, **kwargs):
        ...
        return {"item_name": "example.com", **kwargs}
